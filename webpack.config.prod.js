...
class BrayLeinoSplashConcatPlugin {
  constructor(options) {
    // console.log(options);
  ...
  apply(compiler) {
    ...
    compiler.hooks.compilation.tap('BrayLeinoSplashConcatPlugin', (compilation) => {
      HtmlWebpackPlugin.getHooks(compilation).beforeAssetTagGeneration.tapAsync(
        'BrayLeinoSplashConcatPlugin',
        (data, cb) => {
...
module.exports = {
  ...
  plugins: [
    ...
    new BrayLeinoSplashConcatPlugin({
      css: {
